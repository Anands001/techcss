...
<nav class="navbar navbar-expand-lg navbar-light shadow-sm bg-light fixed-top">
    ...
    <span class="ml-3 font-weight-bold">ICAPO</apan>
    ...
    <li class="nav-item px-lg-2 active"> <a class="nav-link" href="#"> <span class="d-inline-block d-lg-none icon-width"><i class="fa-solid fa-house"></i></span>Home</a> </li>
    ...
    <li class="nav-item px-lg-2"> <a class="nav-link" href="#"><span class="d-inline-block d-lg-none icon-width"><i class="fa-solid fa-address-book"></i></span>Contact</a> </li>
    </ul>
